  ...
  head: () => ({
    meta: [
      ...
      { title: "Tindiholdings — Premium Multi-Branch Commerce" },
      {
        name: "description",
        content:
          "Tindiholdings is a premium multi-branch e-commerce platform offering innovative solutions across diverse industries.",
      },
      {
        name: "keywords",
        content:
          "e-commerce, multi-branch, technology, logistics, hospitality, fashion, innovation",
      },
      ...
      { property: "og:title", content: "Tindiholdings — Premium Multi-Branch Commerce" },
      {
        ...
        content:
          "Tindiholdings provides cutting‑edge multi‑branch commerce solutions for various sectors.",
      },
      ...
      { name: "twitter:title", content: "Tindiholdings — Premium Multi-Branch Commerce" },
      {
        ...
        content:
          "Explore Tindi Holdings' integrated platforms for tech, logistics, hospitality, and fashion.",
      },
